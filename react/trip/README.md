  ...
  - 智能生成图片
    ...
    - 设计工作流
      ...
      - 图片生成流程
        ...
        - 大模型 特征提取
          prompt
    - workflow_id 7533135063622959147
    - token pat_4ljWDT2hIlA71BV9GPDtf5okyGKAT6irED7NCo2zPCZJnpmKSqrEUeH2pB5M6zh2
    - coze 图片要先上传到 coze 中
...
- 用户体验优化
  ...
  - 文件上传的 preview html5 FileReader 对象
...
- 升级瀑布流？
  ...
  - 骨架屏
  - 奇偶 images 两列分配可能有时候会像天蚕脚一样，不好看，随机嘛
    - 两个响应式数组, 判断哪一列高度更少，将新得到的 img 加入哪个数组
...
- AI 功能
  智能前端(http 请求) + 工作流 + coze api + ai 全新工作链路 + 自动化 Agent
