...
// https 加密的http 更安全
// chat 聊天的方式 messages 
var endpoint = "https://api.deepseek.com/chat/completions"; // 请求头 

var headers = {
  // 内容类型
  "Content-Type": "application/json",
  // 授权
  "Authorization": "Bearer sk-847db375635e4000b5d0622f10515a68"
}; // 请求体
...
fetch(endpoint, {
  ...
  body: JSON.stringify(payload) // 请求 + LLM 生成需要花时间 
  // http 是基于请求响应的简单协议
  // 返回的也是文本或二进制流
